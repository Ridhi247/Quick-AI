...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-10">
        <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
            <div className="md:max-w-96">
                <img className="h-9" src={assets.logo} alt="logo" />
                <p className="mt-6 text-sm">
                    Experience the future of content creation with AI Tools, <br /> your ultimate platform for generating high-quality, engaging content effortlessly. <br/>
                    Transform your ideas into captivating articles, blogs, and more with just a few clicks.
                </p>
            </div>
